...
internal val GlassSurfaceTopDark = Color(0x991E1E24)
internal val GlassSurfaceBottomDark = Color(0x8C101014)

internal val GlassSurfaceSolidTopLight = Color(0xFFFFFFFF)
internal val GlassSurfaceSolidBottomLight = Color(0xFAEDF1F8)
internal val GlassSurfaceSolidTopDark = Color(0xE61E1E24)
internal val GlassSurfaceSolidBottomDark = Color(0xE6101014)

internal val GlassEdgeTopLight = Color(0xF2FFFFFF)
internal val GlassEdgeBottomLight = Color(0x1F0B0B12)
internal val GlassEdgeTopDark = Color(0x5CFFFFFF)
internal val GlassEdgeBottomDark = Color(0x14FFFFFF)
